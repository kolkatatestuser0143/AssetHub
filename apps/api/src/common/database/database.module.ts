...
const MODEL_PROVIDERS = [
  { name: TenantModelName, schema: TenantSchema }, { name: CompanyModelName, schema: CompanySchema },
  { name: BusinessUnitModelName, schema: BusinessUnitSchema }, { name: PlantModelName, schema: PlantSchema },
  { name: LocationModelName, schema: LocationSchema }, { name: DepartmentModelName, schema: DepartmentSchema },
  { name: UserModelName, schema: UserSchema }, { name: SessionModelName, schema: SessionSchema },
  { name: LoginHistoryModelName, schema: LoginHistorySchema }, { name: PermissionModelName, schema: PermissionSchema },
  ...
  { name: ScimTokenModelName, schema: ScimTokenSchema }, { name: ScimSyncLogModelName, schema: ScimSyncLogSchema },
  { name: IntegrationInstanceModelName, schema: IntegrationInstanceSchema }, { name: PlanModelName, schema: PlanSchema },
  { name: SubscriptionModelName, schema: SubscriptionSchema }, { name: EntitlementModelName, schema: EntitlementSchema },
  { name: AuditEventModelName, schema: AuditEventSchema }, { name: PlatformAdminNoteModelName, schema: PlatformAdminNoteSchema },
  { name: AssetReportTemplateModelName, schema: AssetReportTemplateSchema },
];

@Global()
@Module({
  imports: [MongooseModule.forRootAsync({ useFactory: () => ({ uri: process.env.MONGODB_URI }) }), MongooseModule.forFeature(MODEL_PROVIDERS)],
