...
export class IdentityService {
  ...
  async listScimTokens(auth: AuthContext, companyId: string) {
    ...
    return docs.map((doc: any) => ({ id: String(doc._id), companyId: doc.companyId, label: doc.label ?? null, deprovisionPolicy: doc.deprovisionPolicy, revokedAt: doc.revokedAt ?? null, createdAt: doc.createdAt, active: !doc.revokedAt }));
  }
