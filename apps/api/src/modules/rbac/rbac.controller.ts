...
class RoleScopeDto {
  @IsIn(['TENANT', 'COMPANY', 'LOCATION'])
  scopeType: RoleScopeInput['scopeType'];
...
export class RbacController {
  ...
  @Get(':roleId/scopes')
  @RequirePermission('role:read')
  listScopes(@Param('roleId') roleId: string, @Req() req: any) {
    return this.rbac.listRoleScopes(req.authContext, roleId);
  }
  ...
  setScopes(
    ...
    @Body() dto: RoleScopesDto,
    @Req() req: any,
  ) {
    return this.rbac.setRoleScopes(req.authContext, roleId, dto.scopes as RoleScopeInput[]);
  }
