...
export class AssetsController {
  ...
  @Get('vendors') @RequirePermission('asset:read') async listVendors(@Query('companyId') companyId: string | undefined, @Req() req: any) { const target = await this.resolveCompany(req.authContext, companyId); return this.assets.listVendors({ ...req.authContext, companyId: target }); }
