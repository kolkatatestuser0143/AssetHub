...
export class TenancyController {
  ...
  @Get(':companyId/business-units')
  @RequirePermission('company:read')
  listBusinessUnits(@Param('companyId') companyId: string, @Req() req: any) {
    return this.tenancy.listBusinessUnits(req.authContext, companyId);
  }
  ...
  @Get('business-units/:businessUnitId/plants')
  @RequirePermission('company:read')
  listPlants(@Param('businessUnitId') businessUnitId: string, @Req() req: any) {
    return this.tenancy.listPlants(req.authContext, businessUnitId);
  }
  ...
  @Get('plants/:plantId/locations')
  @RequirePermission('company:read')
  listLocations(@Param('plantId') plantId: string, @Req() req: any) {
    return this.tenancy.listLocations(req.authContext, plantId);
  }
  ...
  @RequirePermission('company:read')
  listDepartments(@Param('locationId') locationId: string, @Req() req: any) {
    return this.tenancy.listDepartments(req.authContext, locationId);
  }
