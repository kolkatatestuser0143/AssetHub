...
export async function connectTestDb(): Promise<TestDb> {
  ...
  const db = new MongooseDatabaseService(tenantModel, companyModel, null as any, null as any, null as any, null as any, userModel, null as any, null as any, null as any, null as any, assetTypeModel, assetModel, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any, null as any);
...
export async function seedTwoTenants(db: MongooseDatabaseService) {
  ...
  const authA: AuthContext = { userId: String(userA._id), sessionId: `test-session-a-${suffix}`, tenantId: String(tenantA._id), companyId: String(companyA._id), crossCompany: false, permissions: ['asset:read','asset:write','company:read','company:write'], forcePasswordReset: false };
  const authB: AuthContext = { userId: String(userB._id), sessionId: `test-session-b-${suffix}`, tenantId: String(tenantB._id), companyId: String(companyB._id), crossCompany: false, permissions: ['asset:read','asset:write','company:read','company:write'], forcePasswordReset: false };
