...
async function main() {
  ...
  // Mongoose's native database handle is obtained from the MongoClient.
  // This avoids relying on mongoose.connection.db being populated by the
  // time the connection promise resolves across Mongoose versions.
