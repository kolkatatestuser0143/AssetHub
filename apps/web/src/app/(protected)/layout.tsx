...
import { Bell, Building2, Boxes, ClipboardList, FileKey2, LayoutDashboard, Laptop, LogOut, Menu, Settings, ShieldCheck, Users, X } from 'lucide-react';
import { useAuth } from '../../lib/auth-context';

const NAV = [
  ['/dashboard','Dashboard',LayoutDashboard], ['/assets','Assets',Laptop], ['/asset-types','Asset types',Boxes],
  ['/companies','Companies & structure',Building2], ['/roles','Roles & permissions',ShieldCheck],
  ['/identity','Identity & SSO',FileKey2], ['/audit','Audit log',ClipboardList], ['/users','Users',Users],
] as const;
