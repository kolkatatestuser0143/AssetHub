...
export default function NewAssetPage() {
  ...
  async function loadInitial() {
    ...
    try {
      ...
      const initialCompanyId = nextHierarchy.length === 1 ? nextHierarchy[0].id : '';
      setForm((v) => ({ ...v, companyId: v.companyId || initialCompanyId }));
