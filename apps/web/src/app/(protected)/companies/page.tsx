...
export default function CompaniesPage() {
  ...
  async function remove(kind: Modal['kind'], node: Node) {
    ...
    try {
      ...
      await apiFetch(url, { method: 'DELETE' }); await load();
