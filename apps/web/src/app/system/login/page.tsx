          ...
          <div className="relative z-10">
            ...
            <div className="mt-28 max-w-xl">
              ...
              <h1 className="mt-5 text-5xl font-bold leading-[1.08] tracking-tight xl:text-6xl">
                Control the platform. Protect every tenant.
              </h1>
              <p className="mt-6 max-w-lg text-lg leading-8 text-blue-100/80">
                The system console is reserved for platform administrators managing tenants, subscriptions, security policies and global configuration.
              </p>
            </div>
          </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-[0_24px_70px_rgba(15,23,42,0.10)] sm:p-9">
              <div className="mb-8">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Use your platform administrator credentials. Tenant accounts cannot access this console.
                </p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="system-email" className="mb-2 block text-sm font-semibold text-slate-700">
                    Email address
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="admin@assethub.local"
                      className="w-full rounded-xl border border-slate-200 bg-white py-3.5 pl-10 pr-4 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                    />
                  </div>
                </div>

                <div>
                  <label htmlFor="system-password" className="mb-2 block text-sm font-semibold text-slate-700">
                    Password
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-200 bg-white py-3.5 pl-10 pr-11 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={busy}
                  className="flex w-full items-center justify-center rounded-xl bg-blue-600 px-4 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {busy ? 'Signing in…' : 'Sign in to System Console'}
                </button>
              </form>

              <div className="mt-7 border-t border-slate-100 pt-5 text-center text-xs leading-5 text-slate-400">
                Protected platform area · Unauthorized access is prohibited
              </div>
            </div>
          </div>
        </section>
