      ...
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between bg-gradient-to-br from-slate-950 via-blue-950 to-blue-800 p-12 text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3"><div className="grid h-10 w-10 place-items-center rounded-xl bg-white/10 ring-1 ring-white/15 backdrop-blur"><ShieldCheck className="h-5 w-5" /></div><span className="text-xl font-bold tracking-tight">AssetHub</span></div>
